...
Object3D_list scene1() {
  ...
  shared_ptr<Metal> metal = make_shared<Metal>(Vector(0.8, 0.6, 0.2), 0.2);
  ...
  objs.add(make_shared<Sphere>(10000, Vector(0, -10002, -20), red));
...
int main() {
  ...
  Camera test_cam({0, 0, 0}, {0, 0, -1}, 60, 400, 300);
  ...
  save_vector("test_image", result, 400, 300);
  return 0;
}
